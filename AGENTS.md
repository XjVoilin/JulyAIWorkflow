...
- Give every cross-MDD product symbol one providing MDD. Build one acyclic implementation graph containing all Module and View MDDs plus compile, Luban authoring, registration, Prefab, and runtime-contract edges.
